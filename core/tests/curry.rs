...
pub fn test_uncurry() {
    ...
    let expected_args = Program::to(&[
        Bytes32::const_hex("0x72dec062874cd4d3aab892a0906688a1ae412b0109982e1797a170add88bdcdc").into(),
        Bytes32::const_hex("0x625c2184e97576f5df1be46c15b2b8771c79e4e6f0aa42d3bfecaebe733f4b8c").into(),
        assemble_text("(a (q 2 (q 2 (i 11 (q 2 (i (= 5 (point_add 11 (pubkey_for_exp (sha256 11 (a 6 (c 2 (c 23 ()))))))) (q 2 23 47) (q 8)) 1) (q 4 (c 4 (c 5 (c (a 6 (c 2 (c 23 ()))) ()))) (a 23 47))) 1) (c (q 50 2 (i (l 5) (q 11 (q . 2) (a 6 (c 2 (c 9 ()))) (a 6 (c 2 (c 13 ())))) (q 11 (q . 1) 5)) 1) 1)) (c (q . 0x94a96f7397ff4acb08b6532fd20bb975a2c350c19216fef4ae9f64499bc59fe919bcf7b531dd80a371ad7858bfb288d2) 1))").unwrap().sexp().to_owned(),
    ]);
...
pub fn test_curry_and_treehash() {
    ...
    let arbitrary_mod = dg_xch_puzzles::p2_delegated_puzzle_or_hidden_puzzle::P2_DELEGATED_PUZZLE_OR_HIDDEN_PUZZLE_PROGRAM.clone();
    ...
    for v in 0..500 {
        ...
        let puzzle = arbitrary_mod.curry(&args);
        let puzzle_hash_via_curry = puzzle.tree_hash();
        let mut hashed_args = vec![];
        for arg in args {
            hashed_args.push(arg.tree_hash());
        }
