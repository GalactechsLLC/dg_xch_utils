use crate::proof_of_space::constants::FSE_MAX_SYMBOL_VALUE;
use crate::proof_of_space::finite_state_entropy::bitstream::{
    highbit_32, BitDstream, BitDstreamStatus,
};
use crate::proof_of_space::finite_state_entropy::{
