use crate::proof_of_space::finite_state_entropy::compress::CTable;
use crate::proof_of_space::finite_state_entropy::decompress::{
    build_dtable, decompress_using_dtable, DTable,
};
