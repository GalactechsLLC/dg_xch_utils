...
pub fn test_uncurry() {
    ...
    let expected_args = Program::to(vec![
        Bytes32::from_str("0x72dec062874cd4d3aab892a0906688a1ae412b0109982e1797a170add88bdcdc").unwrap().to_sexp(),
        Bytes32::from_str("0x625c2184e97576f5df1be46c15b2b8771c79e4e6f0aa42d3bfecaebe733f4b8c").unwrap().to_sexp(),
