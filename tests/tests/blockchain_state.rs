...
mod tests {
    ...
    fn test_parse_u128_from_invalid_string() {
        ...
        let result: Result<BlockchainState, _> = serde_json::from_str(&json_data);
        assert!(result.is_err(), "Invalid string should fail deserialization");
    }
    ...
    fn test_parse_u128_from_string_with_whitespace() {
        ...
        let result: Result<BlockchainState, _> = serde_json::from_str(&json_data);
        assert!(result.is_err(), "String with whitespace should fail deserialization");
    }
    ...
    fn test_blockchain_state_serialize_deserialize() {
        let node_id_bytes = decode("abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789").unwrap();
    ...
    fn test_eq_state_min_mempool_fees() {
        ...
        // Case 3: Both are NaN
        let fee4 = MinMempoolFees { cost_5000000: f64::NAN };
        let fee5 = MinMempoolFees { cost_5000000: f64::NAN };
        ...
        let fee6 = MinMempoolFees { cost_5000000: f64::INFINITY };
        let fee7 = MinMempoolFees { cost_5000000: f64::INFINITY };
        assert_eq!(fee6, fee7, "Both Infinity values should be considered equal");
