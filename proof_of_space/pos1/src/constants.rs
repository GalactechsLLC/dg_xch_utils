...
///
/// ```
/// let result = dg_xch_pos1::constants::cdiv(11, 2);
/// assert_eq!(result, 6);
/// ```
///
/// ```
/// let result = dg_xch_pos1::constants::cdiv(10, 2);
/// assert_eq!(result, 5);
/// ```
///
/// ```
/// let result = dg_xch_pos1::constants::cdiv(9, 2);
/// assert_eq!(result, 5);
/// ```
///
/// # Panics
...
/// dg_xch_pos1::constants::cdiv(10, 0);
/// ```
#[must_use]
...
pub use dg_xch_pos_common::finite_state_entropy::FSE_MAX_SYMBOL_VALUE;
