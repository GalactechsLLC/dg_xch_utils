...
use dg_xch_keys::{master_sk_to_singleton_owner_sk, master_sk_to_wallet_sk_unhardened};
...
impl PlotNFTWallet {
    ...
    pub fn find_owner_key(
        ...
        for i in 0..limit {
            let key = master_sk_to_singleton_owner_sk(&self.wallet_store().master_sk, i)?;
